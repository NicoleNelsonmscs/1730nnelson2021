<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="nnelson2H._Default" %>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="form-group">
                <asp:Label ID="Lable1" runat="server" Text="1) DateTime.Now:"></asp:Label>
            ...
            <div class="form-group">
                ...
                <asp:TextBox ID="TextBox5aResult" runat="server" Enabled="False"></asp:TextBox>
            </div>
            <div class="form-group">
                <asp:Label ID="Label6" runat="server" Text="6) DateTime(y, m, d):"></asp:Label>
                <asp:TextBox ID="TextBox6a" runat="server" Width="40px" Text="2019"></asp:TextBox>
        ...
        <div class="col-md-6">
            ...
            <div class="form-group">
                <asp:Label ID="Label20" runat="server" Text="10) StringBuilderAppend:"></asp:Label>
